...
const ACTIONS: ActionDef[] = [
  ...
  },
  {
    ...
    emoji: "😈",
    phrases: [
      "{actor} gets in {target}'s face: 'You are the reason people fake emergencies to leave rooms. Every single time.'",
      "{actor} stares at {target} like something they scraped off their shoe. 'Your existence is a courtesy nobody extended.'",
      "{actor} laughs in {target}'s face. 'You've never once been the smartest, funniest, or most attractive person anywhere. Not once. Not even close.'",
      "{actor} to {target}: 'You talk like you matter and it is genuinely painful to witness.'",
      "{actor} grabs {target} by the collar. 'Everything about you is forgettable. Your face, your voice, your whole pathetic story.'",
      "{actor} cuts {target} off mid-sentence. 'Nobody was listening. Nobody ever is. Take the hint.'",
      "{actor} looks {target} up and down slowly. 'I've seen better put together things fall out of a trash bag.'",
      "{actor} tells {target} flat out: 'You are not a main character. You're not even background. You're a plot hole.'",
      "{actor} grabs {target}'s jaw and makes them look up. 'You will never be enough for anyone. That's not a threat. That's a diagnosis.'",
      "{actor} to {target}, quietly: 'The people who tolerate you talk about you the moment you leave. Every time.'",
      "{actor} shoves {target} back. 'You carry failure like a scent. It walks in before you do.'",
      "{actor} to {target}: 'You peaked in a fantasy you made up. The real version of you is deeply unimpressive.'",
      "{actor} doesn't even raise their voice at {target}. 'You're not worth the volume. You're barely worth the breath.'",
      "{actor} looks {target} dead in the eyes. 'If you disappeared tonight, the silence would be an improvement.'",
      "{actor} grabs {target} by the throat just enough to make a point. 'You mistake being loud for being worth hearing. You are neither.'",
    ],
